...
//------------------------------------------------------------------------
//
//  the miner go outside with a drunkard to have a man-to-man discussion
//------------------------------------------------------------------------

class GoOutside : public State<Miner>
{
private:
	...
	//copy ctor and assignment should be private
	GoOutside(const GoOutside&);
	GoOutside& operator=(const GoOutside&);
